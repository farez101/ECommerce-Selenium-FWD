...
public class P10_wishlistAdding {
    ...
    public WebElement Add_Apple_MacBook_wishlist() {
    ...
    public WebElement Add_Laptop_Samsung_wishlist() {
        return Hooks.driver.findElement(By.id("add-to-wishlist-button-6"));
    }
